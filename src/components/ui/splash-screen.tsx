...
export function SplashScreen() {
  ...
  useEffect(() => {
    ...
    // Dismiss as soon as the page has fully loaded
    const onLoad = () => setShowSplash(false);
  ...
  // If offline, force splash to stay visible
  const visible = showSplash || isOffline;
            ...
            >
              <div className="relative">
                <Image
                  ...
                  width={48}
                  height={48}
                  className="rounded-xl bg-white p-1 shadow-[0_0_20px_rgba(34,197,94,0.4)]"
                />
